...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Primary Binding Cache</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.jennic.ZPSConfiguration.impl.PrimaryBindingCacheImpl#getTableSize <em>Table Size</em>}</li>
 *   <li>{@link com.jennic.ZPSConfiguration.impl.PrimaryBindingCacheImpl#getNumTables <em>Num Tables</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PrimaryBindingCacheImpl extends BindingCacheImpl implements PrimaryBindingCache {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	protected PrimaryBindingCacheImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ZPSConfigurationPackage.Literals.PRIMARY_BINDING_CACHE;
	}
	...
	public void setTableSize(BigInteger newTableSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPSConfigurationPackage.PRIMARY_BINDING_CACHE__TABLE_SIZE, oldTableSize, tableSize));
	}
	...
	public void setNumTables(BigInteger newNumTables) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPSConfigurationPackage.PRIMARY_BINDING_CACHE__NUM_TABLES, oldNumTables, numTables));
	}

 ...
 * (C) Jennic Ltd
 *
 * $Id: ZDOCoordRouterOnlyServersImpl.java 78116 2016-03-24 16:12:56Z nxp29741 $
 */
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ZDO Coord Router Only Servers</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.jennic.ZPSConfiguration.impl.ZDOCoordRouterOnlyServersImpl#getPermitJoiningServer <em>Permit Joining Server</em>}</li>
 *   <li>{@link com.jennic.ZPSConfiguration.impl.ZDOCoordRouterOnlyServersImpl#getMgmtRtgServer <em>Mgmt Rtg Server</em>}</li>
 *   <li>{@link com.jennic.ZPSConfiguration.impl.ZDOCoordRouterOnlyServersImpl#getMgmtMibIeeeServer <em>Mgmt Mib Ieee Server</em>}</li>
 *   <li>{@link com.jennic.ZPSConfiguration.impl.ZDOCoordRouterOnlyServersImpl#getParentAnnceServer <em>Parent Annce Server</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class ZDOCoordRouterOnlyServersImpl extends EObjectImpl implements ZDOCoordRouterOnlyServers {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	protected ZDOCoordRouterOnlyServersImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ZPSConfigurationPackage.Literals.ZDO_COORD_ROUTER_ONLY_SERVERS;
	}
	...
	public NotificationChain basicSetPermitJoiningServer(PermitJoiningServer newPermitJoiningServer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__PERMIT_JOINING_SERVER, oldPermitJoiningServer, newPermitJoiningServer);
	...
	public void setPermitJoiningServer(PermitJoiningServer newPermitJoiningServer) {
		if (newPermitJoiningServer != permitJoiningServer) {
			...
			if (permitJoiningServer != null)
				msgs = ((InternalEObject)permitJoiningServer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__PERMIT_JOINING_SERVER, null, msgs);
			if (newPermitJoiningServer != null)
				msgs = ((InternalEObject)newPermitJoiningServer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__PERMIT_JOINING_SERVER, null, msgs);
			msgs = basicSetPermitJoiningServer(newPermitJoiningServer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__PERMIT_JOINING_SERVER, newPermitJoiningServer, newPermitJoiningServer));
	}
	...
	public NotificationChain basicSetMgmtRtgServer(MgmtRtgServer newMgmtRtgServer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__MGMT_RTG_SERVER, oldMgmtRtgServer, newMgmtRtgServer);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMgmtRtgServer(MgmtRtgServer newMgmtRtgServer) {
		if (newMgmtRtgServer != mgmtRtgServer) {
			...
			if (mgmtRtgServer != null)
				msgs = ((InternalEObject)mgmtRtgServer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__MGMT_RTG_SERVER, null, msgs);
			if (newMgmtRtgServer != null)
				msgs = ((InternalEObject)newMgmtRtgServer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__MGMT_RTG_SERVER, null, msgs);
			msgs = basicSetMgmtRtgServer(newMgmtRtgServer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__MGMT_RTG_SERVER, newMgmtRtgServer, newMgmtRtgServer));
	}
	...
	public NotificationChain basicSetMgmtMibIeeeServer(MgmtMibIeeeServer newMgmtMibIeeeServer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__MGMT_MIB_IEEE_SERVER, oldMgmtMibIeeeServer, newMgmtMibIeeeServer);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMgmtMibIeeeServer(MgmtMibIeeeServer newMgmtMibIeeeServer) {
		if (newMgmtMibIeeeServer != mgmtMibIeeeServer) {
			...
			if (mgmtMibIeeeServer != null)
				msgs = ((InternalEObject)mgmtMibIeeeServer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__MGMT_MIB_IEEE_SERVER, null, msgs);
			if (newMgmtMibIeeeServer != null)
				msgs = ((InternalEObject)newMgmtMibIeeeServer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__MGMT_MIB_IEEE_SERVER, null, msgs);
			msgs = basicSetMgmtMibIeeeServer(newMgmtMibIeeeServer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__MGMT_MIB_IEEE_SERVER, newMgmtMibIeeeServer, newMgmtMibIeeeServer));
	}
	...
	public NotificationChain basicSetParentAnnceServer(ParentAnnceServer newParentAnnceServer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__PARENT_ANNCE_SERVER, oldParentAnnceServer, newParentAnnceServer);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setParentAnnceServer(ParentAnnceServer newParentAnnceServer) {
		if (newParentAnnceServer != parentAnnceServer) {
			...
			if (parentAnnceServer != null)
				msgs = ((InternalEObject)parentAnnceServer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__PARENT_ANNCE_SERVER, null, msgs);
			if (newParentAnnceServer != null)
				msgs = ((InternalEObject)newParentAnnceServer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__PARENT_ANNCE_SERVER, null, msgs);
			msgs = basicSetParentAnnceServer(newParentAnnceServer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ZPSConfigurationPackage.ZDO_COORD_ROUTER_ONLY_SERVERS__PARENT_ANNCE_SERVER, newParentAnnceServer, newParentAnnceServer));
	}

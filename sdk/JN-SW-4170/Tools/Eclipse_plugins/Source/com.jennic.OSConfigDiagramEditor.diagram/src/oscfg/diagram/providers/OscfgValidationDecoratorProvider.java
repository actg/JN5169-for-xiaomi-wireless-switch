 ...
 * @generated
 */
public class OscfgValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = OscfgDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof OscfgDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ConfigurationEditPart.MODEL_ID.equals(OscfgVisualIDRegistry
						.getModelID(view));
	}

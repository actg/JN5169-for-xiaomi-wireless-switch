 ...
 * @generated
 */
public class TaskAutostarted2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TaskAutostarted2EditPart(View view) {
		super(view);
	}
			...
			parser = OscfgParserProvider
					.getParser(
							...
							OscfgVisualIDRegistry
									.getType(oscfg.diagram.edit.parts.TaskAutostarted2EditPart.VISUAL_ID));
		}
		return parser;
	}

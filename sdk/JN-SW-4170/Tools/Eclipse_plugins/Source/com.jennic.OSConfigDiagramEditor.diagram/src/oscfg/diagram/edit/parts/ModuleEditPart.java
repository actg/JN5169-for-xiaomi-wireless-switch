...
import oscfg.diagram.edit.policies.ModuleItemSemanticEditPolicy;
import oscfg.diagram.layoutmanager.CompartmentLayout;
...
public class ModuleEditPart extends ShapeNodeEditPart {
	...
	public class ModuleFigure extends RectangleFigure {
		...
		public ModuleFigure() {
			...
			CompartmentLayout layoutThis = new CompartmentLayout();
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 235, 235, 235);
}

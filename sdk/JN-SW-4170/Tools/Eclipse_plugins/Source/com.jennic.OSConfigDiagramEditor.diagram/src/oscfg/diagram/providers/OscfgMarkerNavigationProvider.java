...
import oscfg.diagram.part.OscfgDiagramEditorUtil;

/**
 * @generated
 */
public class OscfgMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = OscfgDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			OscfgDiagramEditorUtil.selectElementsInDiagram(editor,

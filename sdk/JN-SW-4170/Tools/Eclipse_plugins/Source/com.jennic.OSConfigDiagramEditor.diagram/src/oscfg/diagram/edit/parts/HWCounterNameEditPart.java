 ...
 * @generated
 */
public class HWCounterNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HWCounterNameEditPart(View view) {
		super(view);
	}
			...
			parser = OscfgParserProvider
					.getParser(
							...
							OscfgVisualIDRegistry
									.getType(oscfg.diagram.edit.parts.HWCounterNameEditPart.VISUAL_ID));
		}
		return parser;
	}

 ...
 * @generated
 */
public class TaskPriority2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TaskPriority2EditPart(View view) {
		super(view);
	}
			...
			parser = OscfgParserProvider
					.getParser(
							...
							OscfgVisualIDRegistry
									.getType(oscfg.diagram.edit.parts.TaskPriority2EditPart.VISUAL_ID));
		}
		return parser;
	}

 ...
 * @generated
 */
public class OscfgDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public OscfgDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof OscfgDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((OscfgDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new OscfgDomainNavigatorItem((EObject) objects[i],

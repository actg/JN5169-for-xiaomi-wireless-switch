 ...
 * @generated
 */
public class TaskAutostartedEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TaskAutostartedEditPart(View view) {
		super(view);
	}
			...
			parser = OscfgParserProvider
					.getParser(
							...
							OscfgVisualIDRegistry
									.getType(oscfg.diagram.edit.parts.TaskAutostartedEditPart.VISUAL_ID));
		}
		return parser;
	}

 ...
 * @generated
 */
public class InterruptSourceSourceEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public InterruptSourceSourceEditPart(View view) {
		super(view);
	}
			...
			parser = OscfgParserProvider
					.getParser(
							...
							OscfgVisualIDRegistry
									.getType(oscfg.diagram.edit.parts.InterruptSourceSourceEditPart.VISUAL_ID));
		}
		return parser;
	}

 ...
 * @generated
 */
public class MessageCtypeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MessageCtypeEditPart(View view) {
		super(view);
	}
			...
			parser = OscfgParserProvider
					.getParser(
							...
							OscfgVisualIDRegistry
									.getType(oscfg.diagram.edit.parts.MessageCtypeEditPart.VISUAL_ID));
		}
		return parser;
	}

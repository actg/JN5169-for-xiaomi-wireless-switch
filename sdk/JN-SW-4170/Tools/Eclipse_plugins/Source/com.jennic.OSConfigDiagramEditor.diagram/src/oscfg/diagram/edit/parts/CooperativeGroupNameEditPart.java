 ...
 * @generated
 */
public class CooperativeGroupNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CooperativeGroupNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new OscfgTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return OscfgElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = OscfgParserProvider
					.getParser(
							OscfgElementTypes.CooperativeGroup_3017,
							getParserElement(),
							OscfgVisualIDRegistry
									.getType(oscfg.diagram.edit.parts.CooperativeGroupNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					OscfgEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}

 ...
 * @generated
 */
public class TaskPriorityEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TaskPriorityEditPart(View view) {
		super(view);
	}
			...
			parser = OscfgParserProvider
					.getParser(
							...
							OscfgVisualIDRegistry
									.getType(oscfg.diagram.edit.parts.TaskPriorityEditPart.VISUAL_ID));
		}
		return parser;
	}

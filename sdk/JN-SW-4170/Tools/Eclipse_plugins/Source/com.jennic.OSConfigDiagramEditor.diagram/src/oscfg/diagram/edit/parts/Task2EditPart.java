...
import oscfg.diagram.edit.policies.Task2ItemSemanticEditPolicy;
...
public class Task2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TaskPriority2EditPart) {
			((TaskPriority2EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureTaskPriorityFigure());
			return true;
		}
		if (childEditPart instanceof TaskAutostarted2EditPart) {
			((TaskAutostarted2EditPart) childEditPart)
	 ...
	 * @generated NOT
	 */
	static final Color THIS_BACK = new Color(null, 0, 224, 224);

 ...
 * @generated
 */
public class CallbackFunctionNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CallbackFunctionNameEditPart(View view) {
		super(view);
	}
			...
			parser = OscfgParserProvider
					.getParser(
							...
							OscfgVisualIDRegistry
									.getType(oscfg.diagram.edit.parts.CallbackFunctionNameEditPart.VISUAL_ID));
		}
		return parser;
	}

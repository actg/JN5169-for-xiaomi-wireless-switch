 ...
 * @generated
 */
public abstract class OscfgAbstractExpression {
	 ...
	 * @generated
	 */
	protected OscfgAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = OscfgDiagramEditorPlugin.ID;

 ...
 * @generated
 */
public class ISRTypeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ISRTypeEditPart(View view) {
		super(view);
	}
			...
			parser = OscfgParserProvider
					.getParser(
							...
							OscfgVisualIDRegistry
									.getType(oscfg.diagram.edit.parts.ISRTypeEditPart.VISUAL_ID));
		}
		return parser;
	}

 ...
 * @generated
 */
public class ISRIPLEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ISRIPLEditPart(View view) {
		super(view);
	}
			...
			parser = OscfgParserProvider
					.getParser(
							...
							OscfgVisualIDRegistry
									.getType(oscfg.diagram.edit.parts.ISRIPLEditPart.VISUAL_ID));
		}
		return parser;
	}

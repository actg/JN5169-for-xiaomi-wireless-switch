 ...
 * @generated
 */
public class MessageQueueEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MessageQueueEditPart(View view) {
		super(view);
	}
			...
			parser = OscfgParserProvider
					.getParser(
							...
							OscfgVisualIDRegistry
									.getType(oscfg.diagram.edit.parts.MessageQueueEditPart.VISUAL_ID));
		}
		return parser;
	}

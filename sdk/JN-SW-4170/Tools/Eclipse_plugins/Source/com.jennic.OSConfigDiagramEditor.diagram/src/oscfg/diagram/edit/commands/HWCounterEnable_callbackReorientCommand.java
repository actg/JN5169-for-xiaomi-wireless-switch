 ...
 * @generated
 */
public class HWCounterEnable_callbackReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public HWCounterEnable_callbackReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return OscfgBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistHWCounterEnable_callback_4007(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return OscfgBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistHWCounterEnable_callback_4007(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setEnable_callback(null);
		getNewSource().setEnable_callback(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setEnable_callback(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

 ...
 * @generated
 */
public class HWCounterDisable_callbackReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public HWCounterDisable_callbackReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return OscfgBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistHWCounterDisable_callback_4008(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return OscfgBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistHWCounterDisable_callback_4008(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setDisable_callback(null);
		getNewSource().setDisable_callback(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setDisable_callback(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

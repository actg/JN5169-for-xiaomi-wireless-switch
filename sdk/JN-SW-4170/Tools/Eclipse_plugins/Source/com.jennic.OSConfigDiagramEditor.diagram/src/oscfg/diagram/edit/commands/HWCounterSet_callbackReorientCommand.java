 ...
 * @generated
 */
public class HWCounterSet_callbackReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public HWCounterSet_callbackReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return OscfgBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistHWCounterSet_callback_4010(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return OscfgBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistHWCounterSet_callback_4010(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setSet_callback(null);
		getNewSource().setSet_callback(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setSet_callback(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

 ...
 *
 * $HeadURL: https://www.collabnet.nxp.com/svn/lprf_sware/Projects/Zigbee%20Protocol%20Stack/Modules/APL/Branches/ZBPRO_R20_v1.1/Include/zps_apl_zdo.h $
 *
 * $Revision: 87356 $
 *
 ...
 *
 * $Id: zps_apl_zdo.h 87356 2017-03-17 15:41:13Z nxp29741 $
 *
 *****************************************************************************
 *
...
PUBLIC void *zps_pvAplZdoGetMacHandle(void *);
...
#ifndef ZPS_APL_OPT_NO_APS_SECURITY
...
PUBLIC ZPS_teStatus zps_eAplZdoZllStartRouter(void *pvApl);
...
ZPS_APL_INLINE void *ZPS_pvAplZdoGetMacHandle(void) ZPS_ZDO_ALWAYS_INLINE;
ZPS_APL_INLINE void *ZPS_pvAplZdoGetMacHandle(void)
{
    return zps_pvAplZdoGetMacHandle(ZPS_pvAplZdoGetAplHandle());
}

ZPS_APL_INLINE ZPS_teStatus ZPS_vAplSecSetInitialSecurityState(ZPS_teZdoNwkKeyState eState, uint8 *pu8Key, uint8 u8KeySeqNum, ZPS_teApsLinkKeyType eKeyType ) ZPS_ZDO_ALWAYS_INLINE;
ZPS_APL_INLINE ZPS_teStatus ZPS_vAplSecSetInitialSecurityState(ZPS_teZdoNwkKeyState eState, uint8 *pu8Key, uint8 u8KeySeqNum, ZPS_teApsLinkKeyType eKeyType)
{
    return zps_vAplSecSetInitialSecurityState(ZPS_pvAplZdoGetAplHandle(), eState, pu8Key, u8KeySeqNum, eKeyType);
}
...
ZPS_APL_INLINE ZPS_teStatus ZPS_eAplZdoZllStartRouter(void) ZPS_ZDO_ALWAYS_INLINE;
ZPS_APL_INLINE ZPS_teStatus ZPS_eAplZdoZllStartRouter(void)
{
    return zps_eAplZdoZllStartRouter(ZPS_pvAplZdoGetAplHandle());
}
...
ZPS_APL_INLINE void *ZPS_pvAplZdoGetMacHandle(void *pvApl) ZPS_ZDO_ALWAYS_INLINE;
ZPS_APL_INLINE void *ZPS_pvAplZdoGetMacHandle(void *pvApl)
{
    return zps_pvAplZdoGetMacHandle(pvApl);
}
